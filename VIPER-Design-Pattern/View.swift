...
class DetailViewController : UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        priceLabel.frame = CGRect(x: view.frame.width / 2 - 100, y: view.frame.height / 2 - 25, width: 200, height: 100)
        currencyLabel.frame = CGRect(x: view.frame.width / 2 - 100, y: view.frame.height / 3, width: 200, height: 100)
